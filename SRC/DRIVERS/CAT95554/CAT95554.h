...
#define IOCTL_CAT95554_WRITE       \
    CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0326, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_CAT95554_READ       \
    CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0327, METHOD_BUFFERED, FILE_ANY_ACCESS)
