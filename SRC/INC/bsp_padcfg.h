...
{       \
    ...
    PAD_ENTRY(MMC2_CLK            ,INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR  | MUXMODE(4))     \
    PAD_ENTRY(MMC2_CMD            ,INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR  | MUXMODE(4))     \
    PAD_ENTRY(MMC2_DAT0           ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(MMC2_DAT1           ,INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR  | MUXMODE(4))     \
    PAD_ENTRY(MMC2_DAT2           ,INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR  | MUXMODE(4))     \
...
#define GPMC_PADS \
    ...
    PAD_ENTRY(GPMC_nCS4,        INPUT_DISABLED | MUXMODE(0))     \
    PAD_ENTRY(GPMC_nCS6,        INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR  | MUXMODE(4))     \
...
#define UART2_PADS \
		PAD_ENTRY(MCBSP3_CLKX, INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(1)) \
...
#define I2C3_PADS   \
    ...
    PAD_ENTRY(I2C3_SDA, INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(4))   
...
#define MCSPI2_PADS \
    PAD_ENTRY(MCSPI2_CS0, INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(0)) \
    PAD_ENTRY(MCSPI2_SOMI,INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(0)) \
    PAD_ENTRY(MCSPI2_SIMO,INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(0)) \
    PAD_ENTRY(MCSPI2_CLK, INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(0)) 

#define MCBSP1_PADS \
    PAD_ENTRY(MCBSP1_CLKX, INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) \
    PAD_ENTRY(MCBSP1_FSX,  INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(0)) \
    PAD_ENTRY(MCBSP1_DX,   INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4))
	//PAD_ENTRY(MCBSP1_DR,   INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* gpio 159 use as ehci phy rst*/
...
#define GPIO_PADS   \
    PAD_ENTRY(ETK_D13,			INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* gpio 27 touch irq HSUSB2_NXT */ \
    PAD_ENTRY(ETK_D11,			INPUT_ENABLED | MUXMODE(4))      /* GPIO 25  : LAN irq*/	\
    PAD_ENTRY(SYS_NIRQ,         INPUT_ENABLED | MUXMODE(4))      /* GPIO 0  : TPS659XX irq*/	\
	PAD_ENTRY(MCBSP1_DR,		INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* gpio 159 use as ehci phy rst*/ \
	PAD_ENTRY(MCBSP1_FSX,		INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 161 bt enable*/
...
#if 0
#define MCSPI2_PADS	\
    PAD_ENTRY(MCSPI2_SIMO,INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB2_D4  */ \
    PAD_ENTRY(MCSPI2_SOMI,INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB2_D5  */ \
    PAD_ENTRY(MCSPI2_CS0, INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB2_D6  */ \
	PAD_ENTRY(MCSPI2_CLK, INPUT_DISABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB2_D7  */ \
	PAD_ENTRY(ETK_D13,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* USB2_CLK   */
#endif
